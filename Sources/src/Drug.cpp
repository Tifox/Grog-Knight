...
/*Drug*			Drug::getDrugName(void) {
	...
	while (dirEntry = readdir(dir)) {
		...
		this->_allDrugs.push_back(std::string(dirEntry->d_name));
		}
	}
}
*/
...
/**
 * Returns a new random Drug
 */
/*Drug		*Drug::getDrugRandom(void) {
	getDrugName();
	...
	return (new Drug (*this->_allDrugs.begin()));
}
*/