...
\hline
\end{DoxyParams}
\hypertarget{class_elements_a6682ad84a7d56dd6d58ba0517965b584}{\index{Elements@{Elements}!Anim\+Callback@{Anim\+Callback}}
\index{Anim\+Callback@{Anim\+Callback}!Elements@{Elements}}
\subsubsection[{Anim\+Callback}]{\setlength{\rightskip}{0pt plus 5cm}void Elements\+::\+Anim\+Callback (
\begin{DoxyParamCaption}
\item[{String}]{s}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_elements_a6682ad84a7d56dd6d58ba0517965b584}


Animation callback. 

The animation callback function This function is only used here for block / background purposes, And be overriden in \hyperlink{class_characters}{Characters} childs. 
\begin{DoxyParams}{Parameters}
{\em } & s The Animation name. \\
\hline
\end{DoxyParams}


Reimplemented in \hyperlink{class_characters_a6354b7fd409cde57312c5eca1cf43275}{Characters}.
...
Load physics on element, and add him to the World. \begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000007}{Todo}]This function is quite nasty, maybe a rework on it should be better. \end{DoxyRefDesc}
